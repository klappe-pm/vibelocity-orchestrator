# LLM-Optimized Agent Definition Specification
This is an example file format. This example file format must be used to define all project agents and sub-agents
...
model_configuration:
  ...
  concurrent_compatible: [true|false]
...
# ============================================================
core_directive: |
  [Single paragraph describing the agent's primary purpose in imperative language]
  Example: "You are responsible for analyzing user requirements and generating 
  technical specifications. Parse input requests, identify ambiguities, and 
  produce structured specification documents."

# ============================================================
# RESPONSIBILITIES (Actionable)
# ============================================================
responsibilities:
  primary:
    - action: "[Verb] [Object]"
...
outputs:
  primary_artifact:
    ...
    example: |
      [Show complete example of expected output]
...
sub_agents:
  - name: "[Sub-Agent Name]"
    ...
    model: "[model_name]"
    input_interface: |
      [Structured format for passing tasks to sub-agent]
    output_interface: |
...
examples:
  ...
  example_2:
    ...
    input: |
      [Edge case input]
    expected_behavior: "[How agent should handle this]"
...
## Key Improvements for LLM Usability:
...
- Imperative language ("Parse", "Generate", "Validate")
...
- Workflow phases with clear steps
...
This format enables LLMs to:

- Parse and understand their role unambiguously
...
- Operate consistently across different implementations